// Canonical starts of the 240 rubs (quarters) in mushaf order.
// Source: Tanzil Quran metadata (quran-data.xml, CC BY 3.0).
export const QURAN_QUARTER_STARTS: ReadonlyArray<readonly [surah: number, ayah: number]> = [
